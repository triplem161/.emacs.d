...
*** Omnisharp
	...
	#+BEGIN_SRC emacs-lisp
      (use-package omnisharp
        ...
        :config
        ;;(setq omnisharp-server-executable-path "C:\\Programming\\Omnisharp\\omnisharp-roslyn\\artifacts\\publish\\OmniSharp\\default\\net46\\OmniSharp.exe")
      ;;  (setq omnisharp-server-executable-path "C:\\Programming\\omniros\\OmniSharp.exe")

...
** Expand Region
   #+BEGIN_SRC emacs-lisp
     (use-package expand-region
       ...
       :defer t
       :init
       (add-hook 'prog-mode-hook 'expand-region)
...
** OrgMode
   #+BEGIN_SRC emacs-lisp
     (setq todo-file-path "c:/Users/OpenMind2/Google \Drive/GTD/todo.org")
     ...
     ;; (setq org-agenda-files '("c:/Users/OpenMind2/Google \Drive/GTD/todo.org" "c:/Users/OpenMind2/Google \Drive/GTD/projects.org"))
     ;; (setq org-agenda-files '(todo-file-path project-file-path))

     (setq org-refile-targets '((project-file-path :maxlevel . 1)))
     (setq org-refile-allow-creating-parent-nodes 'confirm)

     (setq org-capture-templates '(("t" "TODO" entry
				    (file+headline todo-file-path "Todo")
				    "* TODO %i%?")))
